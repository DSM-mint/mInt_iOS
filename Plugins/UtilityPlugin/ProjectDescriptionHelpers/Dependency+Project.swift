...
public extension TargetDependency.Project {
    ...
    static let APPNetwork = TargetDependency.project(target: "MintNetwork", path: .relativeToRoot("Projects/Modules/MintNetwork"))
    
    static let APPKit = TargetDependency.project(target: "MintKit", path: .relativeToRoot("Projects/Modules/MintKit"))
}
