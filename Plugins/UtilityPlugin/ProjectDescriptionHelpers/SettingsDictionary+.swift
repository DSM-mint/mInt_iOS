...
public extension SettingsDictionary {
    ...
    func setProvisioningDevelopment() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "Mint iOS Debug")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "Mint iOS Debug")])
    }
    
    func setProvisioningAppstore() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "Mint iOS Release")])
            .merging(["CODE_SIGN_IDENTITY[sdk=iphoneos*]": SettingValue(stringLiteral: "iPhone Distribution")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "Mint iOS Release")])
    }
}
